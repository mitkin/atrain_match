...
import os
# PPS changed file names from version 2014. Indicate if you are using PPS version 2014 (or higher).
PPS_FORMAT_2012_OR_EARLIER = True
...
SPARC_CLOUD_VALIDATION = False
SPARC_CLOUD_THRESHOLD = 60.0
NAIVE_CLOUD_VALIDATION = True
NAIVE_CLOUD_THRESHOLD = 60.0
...
_validation_results_dir = os.environ.get('VALIDATION_RESULTS_DIR', "/nobackup/smhid9/sm_kgkar/atrain_match")
#Not really used????/KG
...
MAIN_DIR = os.environ.get('VALIDATION_RESULTS_DIR', "/nobackup/smhid9/sm_kgkar/atrain_match")
...
RESHAPE_DIR = "%s/Reshaped_Files_Naive_test2" %MAIN_DIR
...
RESULT_DIR = "Results_Naive_test2"
...
SAT_ORBIT_DURATION = 110*60 #Not to large (maybe enough with 90x60????)
...
# ..but OBSERVE: run only with mode BASIC first if you want to redo the matching again (PROCESS_MASTER with option -r)
...
if CALIPSO_CLOUD_FRACTION == True:
    COMPILED_STATS_FILENAME = '%s/Results_Naive_test2/CCF' %MAIN_DATADIR
