...
def naive_read_prob(filename,prob_threshold,prob_result_dir,ctype_PPS):
    ...
    ctype.des = "This is a faked Naive cloudtype"
...
##             ctype.qualityflag)
    ...
    probname = "%s%s__cloudprob_naive.h5" % (prob_result_dir,sl_[0])
    print probname
...
##     cloudprob = np.array(dataset['data'])   /First used for a few files - now abandoned!/KG
##     print "type cloudprod", type(cloudprob)
##     print "size cloud prob %d"%(len(cloudprob))
    h5file.close()
